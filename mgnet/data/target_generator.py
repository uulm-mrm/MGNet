...
# https://github.com/facebookresearch/detectron2/blob/main/projects/Panoptic-DeepLab/panoptic_deeplab/target_generator.py  # noqa
...
class PanopticDeepLabTargetGenerator(object):
    """
    Generates training targets for MGNet. The center_weights are calculated different than
    in the reference implementation for better performance.
    """
    ...
    def __init__(
        ...
        self.thing_ids = sorted(list(thing_ids))
    ...
    def __call__(self, panoptic, segments_info):
        ...
        center_weights[semantic < self.thing_ids[0]] = 1
